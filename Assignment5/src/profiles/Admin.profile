...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        ...
        <field>Training_Session__c.Average_of_Rating__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Training_Session__c.Count_of_Rating__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Training_Session__c.Mode_of_Session__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Training_Session__c.Number_of_Attendees__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Training_Session__c.Number_of_Sessions__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Training_Session__c.Sum_of_Rating__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Training_Session__c-Page Layout For Webinar</layout>
        <recordType>Training_Session__c.Webinar</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Training_Session__c-Page Layout For Workshop</layout>
